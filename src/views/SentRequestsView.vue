    ...
    <div class="max-w-3xl mx-auto space-y-6">
      ...
      <div class="grid grid-cols-3 gap-4">
        ...
        >
          ...
          <p
            class="text-xs text-yellow-600 dark:text-yellow-500 uppercase font-medium"
          >
        ...
        >
          ...
          <p
            class="text-xs text-green-600 dark:text-green-500 uppercase font-medium"
          >
      ...
      <div v-if="loading" class="space-y-3">
        <div v-for="i in 3" :key="i" class="app-card p-5 animate-pulse">
          <div
            class="h-4 bg-gray-200 dark:bg-gray-700 rounded w-1/3 mb-3"
          ></div>
          <div
            class="h-3 bg-gray-200 dark:bg-gray-700 rounded w-2/3 mb-2"
          ></div>
      ...
      <TransitionGroup name="list" tag="div" class="space-y-4" v-else>
        ...
        >
          ...
          <div class="px-5 py-4 space-y-3">
            ...
            >
              ...
              <span class="text-secondary"
                >{{ t('reassignment.visitIdLabel') }}:</span
              >
              <span
            ...
            >
              <p
                class="text-xs font-medium text-secondary mb-1 uppercase tracking-wide"
              >
          ...
          <div v-if="r.status === 'PENDING'" class="px-5 pb-5">
            <div
              class="flex gap-3 pt-2 border-t border-gray-100 dark:border-gray-700"
            >
              <button
        ...
        <template #footer>
          <div class="flex gap-2 justify-end">
            ...
            <FwbButton @click="confirmCancel" color="red">
              {{ t('common.yes') }},
              {{ t('sentRequests.cancelRequest').toLowerCase() }}
            </FwbButton>
          </div>
        </template>
      </FwbModal>
