  ...
  >
    ...
    <div class="flex flex-wrap items-center justify-between gap-3 mb-4">
      <div class="flex items-center gap-2">
        ...
        <div>
          <h2
            class="text-sm font-bold text-gray-700 dark:text-white uppercase tracking-wider"
          >
    ...
    <div
      v-if="loading"
      class="flex items-center justify-center py-6 gap-2 text-gray-400"
    >
      <div
        class="inline-block animate-spin rounded-full h-5 w-5 border-2 border-blue-500 border-t-transparent"
      ></div>
      <span class="text-sm">{{
        t('agentDashboard.inventoryMetricsLoading')
      }}</span>
    </div>
    ...
    <div v-else-if="metrics" class="grid grid-cols-2 sm:grid-cols-4 gap-3">
      ...
      >
        ...
        <span
          class="text-xs font-semibold text-gray-600 dark:text-gray-300 mt-1"
        >
      ...
      >
        <IconLucideCheckCircle
          class="w-5 h-5 text-green-600 dark:text-green-400 mb-1"
        />
      ...
      >
        <IconLucideArchive
          class="w-5 h-5 text-orange-500 dark:text-orange-400 mb-1"
        />
