  ...
  <div class="space-y-4">
    <div v-if="loading" class="space-y-4">
      ...
      >
        <div class="p-8 flex items-center gap-6">
          <div
            class="w-14 h-14 bg-gray-200 dark:bg-gray-700 rounded-2xl shrink-0"
          />
    ...
    >
      ...
      >
        ...
        <p
          class="text-base text-secondary mt-2 max-w-sm leading-relaxed mx-auto"
        >
        ...
        >
          ...
          <div class="flex-1 min-w-0">
            ...
            <div class="flex flex-wrap items-center gap-x-4 gap-y-2 mt-2">
              ...
              <span class="text-gray-300 dark:text-gray-700 hidden xs:inline"
                >|</span
              >
              <div
                class="text-xs text-secondary flex items-center gap-1.5 font-medium"
              >
          ...
          >
            ...
            >
              {{ t('receipts.uploadedOn') }}:
              {{ formatDate(receipt.createdAt) }}
            </p>
          </div>

          <div
            class="flex items-center gap-3 shrink-0 w-full lg:w-auto pt-2 lg:pt-0"
          >
            <FwbButton
    ...
    <FwbModal v-if="showDeleteModal" @close="showDeleteModal = false" size="md">
      ...
      <template #body>
        <div class="p-2 space-y-4">
          <p
            class="text-base text-gray-600 dark:text-gray-400 leading-relaxed font-medium"
          >
